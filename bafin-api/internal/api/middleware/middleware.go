...
func SecurityHeaders() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		c.Set("X-Data-Source", "BaFin Institution Database (portal.mvp.bafin.de) — German Federal Financial Supervisory Authority")
		c.Set("X-Data-Legal-Basis", "KWG §32, WpIG §15, ZAG §10 — publicly mandated licensing register")
		return c.Next()
	}
}
